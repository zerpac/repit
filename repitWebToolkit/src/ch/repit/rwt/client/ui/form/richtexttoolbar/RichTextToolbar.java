 ...
 * the License.
 */
package ch.repit.rwt.client.ui.form.richtexttoolbar;
...
public class RichTextToolbar extends Composite {
  ...
  public RichTextToolbar(RichTextArea richText) {
    ...
    if (basic != null) {
      bottomPanel.add(backColors = createColorList("Arrière-plan"));
      bottomPanel.add(foreColors = createColorList("Avant-plan"));
